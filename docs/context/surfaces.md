...
This file owns surface-level routing, surface-specific failure prevention,
...
baseline validation rules ([`repo.md`](./repo.md)), workflow procedure
([`workflows.md`](./workflows.md)), Repomix procedure ([`repomix.md`](./repomix.md)),
or regression cases ([`evals.md`](./evals.md)).
...
from [`repo.md`](./repo.md). Do not require `mise run doctor` unless setup,
toolchain, rendered config, task behavior, health-check behavior, scripts, CI
semantics, versions, dependencies, or lockfiles change.
...
| --- | --- | --- | --- | --- | --- |
| Chezmoi | Work touches or cites source-state templates, scripts, attributes, externals, hooks, rendered target state, or phase-sensitive provisioning. | Do not edit rendered target state, treat source-state paths as target paths, normalize Go Template whitespace, rewrite trigger comments, or move script logic as cleanup. | Current source state, affected data or template consumers, and rendered-output or trigger evidence when rendered behavior is claimed or changed. | Documentation-only edits use [`repo.md`](./repo.md). Behavior edits need `chezmoi diff`, `chezmoi execute-template`, trigger review, rendered branch inspection, or host-specific evidence that matches the touched path. | [`.chezmoiscripts/`](../../.chezmoiscripts/), [`.chezmoidata/`](../../.chezmoidata/), [`.chezmoitemplates/`](../../.chezmoitemplates/), [`.chezmoi.toml.tmpl`](../../.chezmoi.toml.tmpl), [`.chezmoiignore.tmpl`](../../.chezmoiignore.tmpl) |
